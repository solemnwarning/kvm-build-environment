...
locals {
  buildkite_url = "https://github.com/buildkite/agent/releases/download/v3.96.0/buildkite-agent-darwin-amd64-3.96.0.tar.gz"
  buildkite_tar = basename(local.buildkite_url)

  xcode_tools_url = "https://archive.org/download/xcode-command-line-tools-16.2/xcode-command-line-tools-16.2.pkg"
  xcode_tools_pkg = "xcode-command-line-tools-16.2.pkg"
