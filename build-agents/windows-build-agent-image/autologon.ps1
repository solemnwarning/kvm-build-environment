# This script replaces the (encrypted) desktop auto-logon password in the LSA
# store with the one in the ADMINISTRATOR_PASSWORD environment variable.
...
$lsaUtil = New-Object PInvoke.LSAUtil.LSAutil -ArgumentList "DefaultPassword"
$lsaUtil.SetSecret($Env:ADMINISTRATOR_PASSWORD)
